<x-layout>
    ...
    <article class="py-8 max-w-screen-sm mx-auto border-b border-gray-200">
        ...
        <a href="/posts" class="text-sm pt-3 pr-3 pb-3 rounded-lg hover:bg-primary-100 hover:pl-3 hover:text-white transition-all ease-in-out duration-500 text-secondary-500">&laquo; Kembali ke semua blog </a>
    </article>
