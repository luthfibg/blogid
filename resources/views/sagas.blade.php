<x-layout>
    ...
    <article class="py-8 max-w-screen-sm mx-auto border-b border-gray-200">
        ...
        <div class="text-base text-gray-300">
            <a href="/authors-saga/{{ $saga->author->username }}" class="text-sm">{{ $saga->author->name }}</a> | <a href="#" class="text-sm"><span class="text-yellow-300"> {{ $saga['project'] }} </span></a> | <a href="#" class="text-sm">{{ $saga->created_at->diffForHumans() }}</a>
        </div>
